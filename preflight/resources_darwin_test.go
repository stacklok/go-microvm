...
func TestCheckResources_Sufficient(t *testing.T) {
	...
	rc := &resourceChecker{
		...
		sysctlUint64: func(_ string) (uint64, error) {
			return 16 * 1024 * 1024 * 1024, nil // 16 GiB
		},
	}
...
func TestCheckResources_InsufficientMemory(t *testing.T) {
	...
	rc := &resourceChecker{
		numCPU: func() int { return 8 },
		sysctlUint64: func(_ string) (uint64, error) {
			return 256 * 1024 * 1024, nil // 256 MiB
		},
	}
...
func TestCheckResources_SysctlError(t *testing.T) {
	t.Parallel()
